...
class WiimoteNode(Node):
    ...
    def connect_wiimote(self, btaddr):
...
class ActivityRecognition():
    ...
    def initUI(self):
        ...
        wm_connect_btn = QtGui.QPushButton("Connect")
        ...
        left_layout.addWidget(wm_connect_btn, 3, 1, 1, 2)
        ...
        left_layout.addWidget(self.training_label, 4, 1, 1, 2)
        left_layout.addWidget(self.training_btn, 5, 1, 1, 2)


        left_group.setLayout(left_layout)
        main_layout.addWidget(left_group, 1, 1, 1, 1)
        ...
        main_layout.addWidget(middle_group, 1, 2, 1, 5)
        ...
        main_layout.addWidget(right_group, 1, 7, 1, 1)
    ...
    def setupNodes(self):
        ...
        self.buffer_node = self.fc.createNode('Buffer')
